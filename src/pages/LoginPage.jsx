                        ...
                        <div className="flex flex-col items-center justify-center text-center">
                            <div className="flex flex-col items-center justify-center text-center">
                                <div className="flex items-center">
                                    ...
                                    <h1 className="text-3xl font-extrabold text-white">Inter<span className="text-cyan-400">viu</span></h1>
                                </div>
                                <p className="text-sm text-slate-400 font-medium">Practice Smarter</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="space-y-5">
                                ...
                                <button
                                    ...
                                    className="w-full relative border border-slate-700/50 px-4 py-3 rounded-xl font-semibold text-base overflow-hidden transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group"
                                >
                                    <div className="absolute inset-0 bg-slate-900 transition-all duration-300 group-hover:scale-105" />
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="w-full relative px-4 py-3 rounded-xl font-semibold text-base overflow-hidden transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed border border-slate-700 bg-slate-900/50 hover:bg-slate-800 text-white flex items-center justify-center gap-3 transition-colors"
                                >
